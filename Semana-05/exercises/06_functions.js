...
function suma (num1, num2){
    ...
    return alert(NaN);
       ...
       console.log('Result of the sum: '+ (num1 + num2));
   }
}
suma('d',5);
...
function validateInteger (num){
    if (Number.isInteger(num)){
        return console.log(num ,'It is an integer');
    }else {
        return console.log(num, 'It is not an integer');
    }
}
validateInteger(5.2);
validateInteger(5);
...
function suma (num1, num2){
    ...
    if((isNaN(num1) || isNaN(num2))){
        ...
        if (Number.isInteger(num1) && Number.isInteger(num2)){
            return console.log('Result of the sum: '+ (num1 + num2));
        } else {
            console.log(Math.round(num1+num2));
            return alert('It is not an integer')
        }
    }
}
suma(10.3,5);
